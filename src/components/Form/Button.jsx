...
const baseStyle =
  "pointer box-border min-w-[8rem] rounded-lg bg-yellow-400 px-[1.2rem] py-[0.8rem] font-primary font-bold text-yellow-800 border-[3px] border-yellow-400 transition";
